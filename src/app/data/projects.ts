...
const projects: IProject[] = [
  {
    name: 'Sistema Financeiro Enterprise',
    description:
    ...
    technologies: ['React/Next.js para frontend', 'Node.js com Express no backend', 'Oracle Cloud para infraestrutura', 'Containerização via Docker'],
  },
  {
